...
bjs.run = function(){
	...
	if(FS.existsSync(confPath)){
		eval(FS.readFileSync(confPath));
	}

	var argvs = process.argv;
	switch (argvs[2]){
		case 'init': require('bjs-init/init.js')(argvs[3]);break;
		case 'wc': require('bjs.complier.js').watch(bjs.config, 0);break;
		case 'wi': require('bjs.complier.js').watch(bjs.config, 1);
	}
}
